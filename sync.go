...
// get SQL string for droping foreignkey for a TableSpec
...
// To generate SQL statements that make table in database consistant with TableSpec
...
// synchronize the DB definion of s SQL database
...
// check whether the table in database consistent with TableSpec
